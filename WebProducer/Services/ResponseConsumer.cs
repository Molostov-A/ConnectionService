...
public class ResponseConsumer : BackgroundService, IDisposable
{
    ...
    public ResponseConsumer(ILogger<ResponseConsumer> logger, ResponsePool responsePool, IOptions<AppSettings> appSettings)
    {
        _logger = logger;
